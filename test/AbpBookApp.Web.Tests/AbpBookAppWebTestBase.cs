...
{
    public abstract class AbpBookAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AbpBookAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AbpBookAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AbpBookAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AbpBookAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AbpBookAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AbpBookAppDbContext, Task<T>> func)
        {
            T result;
